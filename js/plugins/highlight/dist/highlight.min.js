...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},n,r]}}})());hljs.registerLanguage("http",(()=>{"use strict";function e(...e){
...
},n.inherit(s,{relevance:0})]}}})());hljs.registerLanguage("diff",(()=>{"use strict";function e(...e){
return"("+((e=>{const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})());hljs.registerLanguage("cmake",(()=>{"use strict";return e=>({name:"CMake",
...
},e.HASH_COMMENT_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE]})})());hljs.registerLanguage("scss",(()=>{"use strict"
...
begin:"\\\\\\n"}]}}},{className:"attr",begin:n+t+"$"}]}}})());hljs.registerLanguage("dart",(()=>{"use strict";return e=>{const n={
...
},e.C_NUMBER_MODE,{className:"meta",begin:"@[A-Za-z]+"},{begin:"=>"}]}}})());hljs.registerLanguage("bash",(()=>{"use strict";function e(...e){
...
starts:{end:/[^\\]$/,subLanguage:"bash"}}],illegal:"</"})})());hljs.registerLanguage("kotlin",(()=>{"use strict"
